...
const TRANSITIONS: Record<ApplicationStatus, ApplicationStatus[]> = {
  ...
  pre_qualified: ["offer_sent", "information_required", "rejected"],
  pre_approved: ["offer_sent", "pending_finance_approval", "rejected"],
  information_required: ["under_review", "pre_qualified", "rejected"],
  offer_sent: ["offer_accepted", "offer_declined"],
  offer_accepted: ["pending_finance_approval"],
  offer_declined: ["under_review", "rejected"],
